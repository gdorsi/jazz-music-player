...
export function AuthModal({ open, onOpenChange }: AuthModalProps) {
  ...
  const shouldShowTransferRootPlaylist =
    !isSignUp && me?.root.rootPlaylist.tracks.some((track) => !track.isExampleTrack)
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {shouldShowTransferRootPlaylist && (
            <div className="text-sm text-red-500">
              You have tracks in your root playlist that are not example tracks. If you log in with a passkey, your
              playlists will be transferred to your logged account.
            </div>
          )}
          <div className="space-y-4">
            ...
            <div className="text-center text-sm">
              ...
              <button type="button" onClick={handleViewChange} className="text-blue-600 hover:underline">
